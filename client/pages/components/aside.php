<div class="h-screen flex flex-col bg-orange-500 mt-1 px-3 border border-black">
    ...
    <div>
        <h2 class="md:block hidden text-center text-white font-bold text-lg mb-5 hover:text-yellow-800  hover:text-2xl transition-transform"><a href="../my-profile/">Perfil</a></h2>
    </div>
    <div>
